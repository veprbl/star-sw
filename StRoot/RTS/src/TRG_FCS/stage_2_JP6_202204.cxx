...
void  fcs_trg_base::stage_2_JP6_202204(link_t ecal[], link_t hcal[], link_t pres[], geom_t geo, link_t output[])
{    
    int ns=geo.ns;
    ...
    //Akio's 6 square JP
    int e_col_start[2] = { 0, 4};  //these are 2x2 row/col
    int e_col_stop[2]  = { 5, 9};
    int e_row_start[3] = { 0, 4, 8};
    int e_row_stop[3]  = { 7,11,15};
    int h_col_start[2] = { 0, 2};
    int h_col_stop[2]  = { 3, 5};
    int h_row_start[3] = { 0, 2, 5};
    int h_row_stop[3]  = { 4, 7, 9};			  
    ...
    output[1].d[2] = 0 ;
    output[1].d[3] = 0 ;
    output[0].d[4] = (JP2[0] << 0) + (JP2[1]<<1) + (JP2[2]<<2) + (JP2[3]<<3) + (JP2[4]<<4) + (JP2[5]<<5);
    output[1].d[5] = 0 ;
    output[1].d[6] = 0 ;
    output[1].d[7] = 0xAB ;
