...
//	static const int XING_COU = 20 ;	// maximum xings we will look at in simulation and verification
	...
	void stage_0_202109(adc_tick_t adc, geom_t geo, ped_gain_t *pg, uint32_t *to_s1) ;
	...
	void stage_1_202201(uint32_t from_s0[], geom_t geo, link_t to_s2[]) ;
        ...
        void stage_2(link_t ecal[], link_t hcal[], link_t pres[], geom_t geo, link_t output[], uint16_t* s2_to_dsm) ;
	...
	void stage_2_JP5_202206(link_t ecal[], link_t hcal[], link_t pres[], geom_t geo, link_t output[]) ;
        void stage_2_202207(link_t ecal[], link_t hcal[], link_t pres[], geom_t geo, link_t output[], uint16_t* s2_to_dsm) ;
	...
	void stage_3_202207(link_t from_s2[], uint16_t *to_dsm) ;
	...
	uint32_t run_event_sim(int xing, int type) ;	// returns DSM bits
...
//	uint8_t dep ;
	...
	struct sim_t {
		...
		struct {
			...
			uint16_t s2_to_dsm ;	// new in FY22
	...
	static uint16_t EMTHR0 ;
	static uint16_t EMTHR1 ;
	static uint16_t EMTHR2 ;
        static uint16_t EMTHR3 ; //obsolete for 202207 
        static uint16_t ELETHR0 ;
	static uint16_t ELETHR1 ;
	static uint16_t ELETHR2 ;
	static uint16_t HADTHR0 ;
	static uint16_t HADTHR1 ;
  	static uint16_t HADTHR2 ;
        static uint16_t HADTHR3 ; //obsolete for 202207
        static uint16_t JETTHR1 ; //obsolete for 202207 
        static uint16_t JETTHR2 ; //obsolete for 202207      
        static uint16_t JPATHR2 ;      
        static uint16_t JPATHR1 ;      
        static uint16_t JPATHR0 ;      
        static uint16_t JPBCTHR2 ;      
        static uint16_t JPBCTHR1 ;      
        static uint16_t JPBCTHR0 ;      
        static uint16_t JPBCTHRD ;      
        static uint16_t JPDETHR2 ;      
        static uint16_t JPDETHR1 ;      
        static uint16_t JPDETHR0 ;      
        static uint16_t JPDETHRD ;      
