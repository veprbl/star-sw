...
uint16_t        fcs_trg_base::EMTHR0 ;
uint16_t        fcs_trg_base::EMTHR1 ;
uint16_t        fcs_trg_base::EMTHR2 ;
uint16_t        fcs_trg_base::EMTHR3 ;  //obsolete for 202207 
uint16_t        fcs_trg_base::ELETHR0 ;
uint16_t        fcs_trg_base::ELETHR1 ;
uint16_t        fcs_trg_base::ELETHR2 ;
uint16_t        fcs_trg_base::HADTHR0 ;
uint16_t        fcs_trg_base::HADTHR1 ;
uint16_t        fcs_trg_base::HADTHR2 ;
uint16_t        fcs_trg_base::HADTHR3 ; //obsolete for 202207 
uint16_t        fcs_trg_base::JETTHR1 ; //obsolete for 202207 
uint16_t        fcs_trg_base::JETTHR2 ; //obsolete for 202207 
uint16_t        fcs_trg_base::JPATHR2 ;      
uint16_t        fcs_trg_base::JPATHR1 ;      
uint16_t        fcs_trg_base::JPATHR0 ;      
uint16_t        fcs_trg_base::JPBCTHR2 ;      
uint16_t        fcs_trg_base::JPBCTHR1 ;      
uint16_t        fcs_trg_base::JPBCTHR0 ;      
uint16_t        fcs_trg_base::JPBCTHRD ;      
uint16_t        fcs_trg_base::JPDETHR2 ;      
uint16_t        fcs_trg_base::JPDETHR1 ;      
uint16_t        fcs_trg_base::JPDETHR0 ;      
uint16_t        fcs_trg_base::JPDETHRD ;      
...
uint32_t fcs_trg_base::run_event_sim(int xing, int type) 
{
	geom_t geo ;
...
void fcs_trg_base::stage_2(link_t ecal[], link_t hcal[], link_t pres[], geom_t geo, link_t output[2], uint16_t* s2_to_dsm) 
{
